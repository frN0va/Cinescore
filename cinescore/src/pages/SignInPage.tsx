					...
					<div className="bg-neutral-900/50 p-8 rounded-xl shadow-xl border border-neutral-800">
						...
						<div className="mt-6">
							...
							<div className="mt-6 grid grid-cols-2 gap-3">
								<button type="button" className="w-full inline-flex justify-center py-2 px-4 border border-neutral-800 rounded-lg shadow-sm bg-neutral-900 text-neutral-300 hover:bg-neutral-800 transition-colors duration-200">
									<img
										className="h-5 w-5"
